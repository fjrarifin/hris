...
class EmployeePayrollProfile extends Model
{
    ...
    protected $casts = [
        ...
        'dasar_bpjs' => 'integer',
        'dasar_jp' => 'integer',
        'rate_jkn_karyawan_percent' => 'decimal:2',
        'rate_jkn_perusahaan_percent' => 'decimal:2',
        'rate_jht_karyawan_percent' => 'decimal:2',
        'rate_jht_perusahaan_percent' => 'decimal:2',
        'rate_jp_karyawan_percent' => 'decimal:2',
        'rate_jp_perusahaan_percent' => 'decimal:2',
        'rate_jkk_percent' => 'decimal:2',
        'rate_jkm_percent' => 'decimal:2',
        'is_active' => 'boolean',
    ];
