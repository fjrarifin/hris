...
<html>
<head>
    <title>Undangan Wawancara HR - Hompim Play</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #dddddd; border-radius: 5px;">
        @if($isReschedule)
            <h2 style="color: #0f172a; border-bottom: 2px solid #3b82f6; padding-bottom: 10px;">Revisi Undangan Wawancara HR</h2>
        @else
            <h2 style="color: #0f172a; border-bottom: 2px solid #3b82f6; padding-bottom: 10px;">Undangan Wawancara HR</h2>
        @endif
        ...
        @else
            <p>Terima kasih atas ketertarikan Bapak/Ibu untuk bergabung dengan Hompim Play (CV 3 Detik) untuk posisi <strong>{{ $candidate->vacancy->title ?? '[posisi]' }}</strong>. Setelah kami melakukan review terhadap profil Bapak/Ibu, kami ingin mengundang Bapak/Ibu untuk mengikuti HR Interview dengan detail sebagai berikut:</p>
        @endif
        ...
        <p>Mohon konfirmasi apakah Bapak/Ibu bersedia hadir sesuai jadwal tersebut. Apabila belum berkenan, silakan informasikan ketersediaan waktu lainnya agar kami dapat menyesuaikan jadwal.</p>
